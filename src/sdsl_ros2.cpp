...
private:
    ...
    void sdsCallback(const sensor_msgs::msg::LaserScan::SharedPtr msg) {
        ...
        schedule.push_back(std::vector<int>()); schedule[0].push_back(4); schedule[0].push_back(8); schedule[0].push_back(1); schedule[0].push_back(4);
        for (int i = 1; i < 10; i++) {
        ...
        sdsl::Predicate_Dynamic_Naive_Fast<sdsl::R3xS1<FT>, sdsl::R3xS2<FT>, FT, sdsl::Env_R3_PCD<Kernel>> predicate(ds.size(), -1);
        ...
        auto result = sdsl::localize<sdsl::R3xS1<FT>, sdsl::ScheduledSplitter_R3xS1<FT>, sdsl::R3xS2<FT>, FT, sdsl::Env_R3_PCD<Kernel>>(
